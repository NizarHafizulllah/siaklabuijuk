      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-user"></i> <span>Penduduk</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('lihat_data'); ?>"><i class="fa fa-eye"></i> Lihat Data</a></li>
                <li><a href="<?php echo site_url('tambah_penduduk'); ?>"><i class="fa fa-user-plus"></i> Tambah Data</a></li>
                <li><a href="<?php echo site_url('import_data'); ?>"><i class="fa fa-file-excel-o"></i> Import Data</a></li>
              </ul>
            </li>
          </ul>
        </section>
