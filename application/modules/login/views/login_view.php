                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1 ><strong>SIAK Desa Labu Ijuk</strong></h1>
                            <h2 style="color: #af1102">Sistem Informasi Administrasi Kependudukan</h2>
                            <div class="description">
                              <p style="color: #2c3e50; font-weight: bold;"></p>
                            </div>
                        </div>
                    </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <p>Dikelola oleh <a href="https://www.instagram.com/kkn_labu_ijuk/" target="_blank"><strong>Mahasiswa KKN Univertas Teknologi Sumbawa</strong></a> 
                  hak cipta dilindungi Tuhan yang Maha Esa. </p>
              </div>
